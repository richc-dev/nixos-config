  ...
  config = lib.mkIf config.c-opt.graphical.waybar.enable {
    ...
    { pkgs, ... }:
    {
      programs.waybar = {
        ...
        settings = [
          {
            ...
            #####################
            ### Copy-pasted from:
            # https://github.com/dc-tec/nixos-config/blob/a890ee9bf0e93ec7c1652c23e84f4366076642fb/modules/nixos/desktop/desktop-environment/waybar.nix
            #####################
        ...
        ##############################
        ### Copy-pasted from same place as above
        ##############################
